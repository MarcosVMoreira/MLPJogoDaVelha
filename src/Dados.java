...
public class Dados {
    ...
    public static void main(String h[]) {
        ...
        dados.simularJogos(2);

        MultiLayerPerceptron mlp = new MultiLayerPerceptron(9, 100, 9);
        
        //MultilayerPerceptron mlp = new MultilayerPerceptron(camadaEntrada, camadaOculta, camadaSaida);
